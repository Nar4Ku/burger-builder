...
class ContactData extends React.Component {
    state = {
        orderForm: {
            ...
            email: { elementType: 'input', elementConfig: { type: 'email', placeholder: 'Your Email' }, value: '' },
    ...
    orderHandler = (event) => {
        ...
        const order = { ingredients: this.props.ingredients, price: this.props.price };
    ...
    render() {
        ...
        let form = (<form>
            {formElementsArray.map(formElement => (
                <Input key={formElement.id} elementType={formElement.config.elementType} elementConfig={formElement.config.elementConfig}
